...
const EditProfileField = () => {
  ...
  return (
    <div className="max-w-full sm:w-[1130px] p-2 pb-6 mx-auto">
      ...
      <div className="px-4">
        <div>
          <h2 className="text-4xl font-bold capitalize text-center mb-4">
            Edit Profile
          </h2>
          <h5 className="text-2xl font-medium text-center w-full sm:w-[400px] m-auto">
            Update your details to keep your profile current.
          </h5>
        </div>
        <div className="flex flex-col sm:flex-row justify-between gap-[30px] my-6">
          <div className="w-full sm:w-[442px] m-auto flex flex-col gap-4 justify-center">
          ...
          <div className="w-full">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-[30px] h-full">
              <CustomInput
                label="Name"
        ...
        <div className="flex gap-[10px] sm:gap-[30px] justify-start flex-col sm:flex-row-reverse">
          <button
            className={`h-[55px] px-[42px] py-[14px] justify-center items-center rounded-[20px] border  ${
              checkValidate()
                ? "bg-blue-500 text-[#ffffff] hover:bg-blue-600 active:bg-blue-700"
