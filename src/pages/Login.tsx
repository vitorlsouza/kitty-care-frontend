      ...
      <div className={`m-auto sm:w-[600px] max-w-[90%] px-[21px] sm:px-[100px] bg-white border-2 rounded-3xl border-[#B8B8B8] mt-8 ${isPhone ? 'py-[47px] sm:py-[70px] ' : 'pb-[47px] sm:pb-[70px]'}`}>
        ...
        <div className="w-full h-full flex flex-col items-center justify-center">
          <div className="text-center">
            ...
            <p className='font-semibold text-lg md:text-xl'>If you don't register yet go to <span className='text-blue-600 cursor-pointer' onClick={() => navigate('/progress')}>Sign Up</span></p>
          </div>
